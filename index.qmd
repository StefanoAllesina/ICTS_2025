...
The [GitHub repository](https://github.com/StefanoAllesina/XXX) associated with the lecture notes contains the code used to generate the lecture notes, including all the figures and simulations. Crucially, the code depends on the following `R` packages:
