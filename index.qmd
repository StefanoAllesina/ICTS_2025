...
We have four lectures, plus some tutorials. We are going to concentrate on the Generalized Lotka-Volterra model---which turns 100 years old in 2026.
...
The [GitHub repository](https://github.com/StefanoAllesina/ICTS_2025) associated with the lecture notes contains the code used to generate the lecture notes, including all the figures and simulations. Crucially, the code depends on the following `R` packages:
