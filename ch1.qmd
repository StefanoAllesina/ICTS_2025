...
ggplot(dt1) + aes(x = time, y = value, colour = name) + geom_line(linewidth = 1) + geom_line(aes(y = avg), linetype = 3,linewidth = 1) + geom_hline(data = tibble(name = as.character(1:4), value = xstar, linewidth = 1), aes(yintercept = value, colour = name), linetype = 2) + theme_bw() + theme(legend.position = "none")
```
